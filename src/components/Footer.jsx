        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <div className="bg-white p- rounded-full">
                <img
              ...
              <span className="text-xl font-semibold">Abhigyan Gurukul</span>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mt-2 flex items-center space-x-2 font-semibold">
              <span>📞</span>
              <span>9472600836 - 9829491219</span>
            </p>
            <p className="mt-2 flex items-center space-x-2 font-semibold">
              <span>📧</span>
              <a
                href="mailto:admin@abhigyangurukul.com"
